...
class CreateDocumentosordencomprasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('documentosordencompras', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('documentosordencompras');
    }
}
