        ...
        if($request->ajax()){
            ...
            switch ($request->tipo) {
                case 'Pedido':
                    ...
                    $arreglo[13]=Articulo::where("articulos.codigoart","<>", "''")->join("posiciones","posiciones.codigoart", "articulos.codigoart")->join("estantes", "estantes.id", "posiciones.estante_id")->join("bodegas", "estantes.bodega_id", "bodegas.idbodega")->where("bodegas.tipobod","Principal")->where("bodegas.tipobod","Principal")->where("posiciones.cantidadpos",">","0")->select("articulos.codigoart", "articulos.nombreart")->get()->groupBy("articulos.codigoart", "articulos.nombreart")->sortbyDesc("articulos.nombreart");
                    break;
                case 'notificaciones':
