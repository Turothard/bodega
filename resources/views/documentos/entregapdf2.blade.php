...
<html lang="es">
    ...
    <body>
        ...
        <table style="width:100%;">
            ...
            <td  style="width:18%; font-size:11px"> {{date("Y-m-d H:i:s")}}</td>
            </tr>
        </table>
    <br>
    ...
    <table class="tabladetalle">
        ...
        {{$contador =0}}
            ...
            @if ($contador >= 15 && $flag==false)
            {{$flag=true}}
                <tr>
                    <td style="border:none;" colspan="6"><p style="font-size:11px;">*Estados de los Artículos: Nuevo (N); Usado Buen Estado (U BE); Usado Mal Estado (U ME); Dar de Baja (DB).</p></td>
