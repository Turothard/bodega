        ...
        // a computed getter
         ...
         methods: {
             ...
             filtrar(){
                ...
                axios.post('/informes/generar', {tipo:'informefrecuenciacaja',detalle: this.filtros})
                    .then((res) =>{
             ...
             descargarinforme(){
                 console.log(this.filtros);
                axios.post('/informes/export', {tipo:'informefrecuenciacaja',detalle: this.filtros, arreglo:this.detalleinforme})
                    .then((res) =>{
                    setTimeout(function() {
