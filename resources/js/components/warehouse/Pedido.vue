...
<script>
import pedido_generar from "../warehouse/pedidos/pedidogenerar.vue";
import pedido_detalle from "../warehouse/pedidos/pedidodetalle.vue";
export default {
  name: "Pedido",
  components: {
    pedido_generar,
  ...
  created() {
    axios
      .post("/sistema/getdatoswarehouse", { tipo: "Pedido" })
      .then(res => {
