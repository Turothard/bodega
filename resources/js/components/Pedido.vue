            ...
            <div class="modal fade" id="pedidomodal" tabindex="-1" role="dialog" aria-labelledby="pedidomodallabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    ...
                    <div class="modal-header">
                        <h5 v-if="componenteactual=='pedido_generar'" class="modal-title" id="exampleModalLabel">Generar Pedido</h5>
                        <h5 v-if="componenteactual=='pedido_detalle'" class="modal-title" id="exampleModalLabel">Actualizar Pedido</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <component v-bind:is="componenteactual" :datapedido="datapedido" :pedido="pedido" :detallepedido="detallepedido"></component>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button v-if="componenteactual=='pedido_detalle' && pedido.estadoped!='FINALIZADO' && pedido.estadoped!='PENDIENTE' && user=='BODEGA'" type="button" class="btn btn-primary" @click="modificarpedido(pedido)">
    ...
    export default {
        ...
        data(){
            return{
                dt: null,
                datapedido:null,
                pedido:{id:1,sector:'', area:'', ubicacion:'',tipopedido:'',preestablecido:'', cantidad:0},
                detallepedido:[],
                componenteactual:'',
                infopedido:[],
                pedidos: [],
        ...
        created() {
            axios.post('/sistema/getdatos', {tipo:'Pedido'})
                .then((res) =>{
                ...
                // Restaura el contenido al campo de texto
                    ...
                    this.detallepedido = JSON.parse(sessionStorage.getItem("detallepedido"));
        ...
        methods: {
            ...
            detallepedidos(ped,id){
                console.log(ped,id)
                axios.post('/pedidos/getdatos', {tipo:'detallepedido',id:id})
                .then((res) =>{
                    this.pedido= ped;
            ...
            guardarpedido(){
                ...
                if(confirm("¿Está seguro de guardar este pedido?")){
                    axios.post('/pedidos/store', {tipo:'guardarpedido',ped:this.pedido, det:this.detallepedido})
                    .then((res) =>{
                        $(".close").click();
                        this.detallepedido=[];
                        this.pedido={id:parseInt(res.data.id)+1,sector:'', area:'', ubicacion:'',tipopedido:'',preestablecido:'', cantidad:0};
                        sessionStorage.clear();
            ...
            aceptarpedido(ped,id){
                if(confirm("¿Está seguro de confirmar este pedido para ser procesado?")){
                    axios.post('/pedidos/store', {tipo:'aceptarpedido',id:id})
                    .then((res) =>{
            ...
            modificarpedido(pedido){
                ...
                if(pedido.estadoped=='INGRESADO'){
                    this.detallepedido.forEach(element => {
                        if(element.cantidadprodetped=='' || element.cantidadprodetped==null){
                            flag=true;
                        }
                    });
                    if(flag){
                    ...
                    //return;
                    axios.post('/pedidos/store', {tipo:'procesarpedido',id:pedido.id, detalle:this.detallepedido})
                    .then((res) =>{
                        console.log(res.data);
