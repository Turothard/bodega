        ...
        <div class="modal fade" id="inventariomodal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-xl" role="document">
                ...
                <div class="modal-footer">
                    ...
                    <button v-if="tipoinventario=='detalleajuste'" type="button" class="btn btn-primary" @click="guardaravance()" v-show="newinventario.length>0">Actualizar Inventario</button>
